...
SideItemBar::SideItemBar(GameObject& associated) : Component(associated), backToNormal(false) {
    ...
    berryAmount = new Text(*berryObj, ASSETS_PATH("/font/pixel.ttf"), 80, TextStyle::SOLID, "0x", {0, 0, 0, 255});
    ...
    Sprite* berrySprite = new Sprite(*berryObj, ASSETS_PATH("/img/items/Berriest x4.png"));
    ...
    cipoAmount = new Text(*cipoObj, ASSETS_PATH("/font/pixel.ttf"), 80, TextStyle::SOLID, "0x", {0, 0, 0, 255});
    ...
    Sprite* cipoSprite = new Sprite(*cipoObj, ASSETS_PATH("/img/items/cipo.png"));
    ...
    galhoAmount = new Text(*galhoObj, ASSETS_PATH("/font/pixel.ttf"), 80, TextStyle::SOLID, "0x", {0, 0, 0, 255});
    ...
    Sprite* galhoSprite = new Sprite(*galhoObj, ASSETS_PATH("/img/items/galho.png"));
