...
Bomb::Bomb(GameObject &associated) : Trap(associated) {
    AddSprite(TrapState::iddle, ASSETS_PATH("/img/trap/flower.png"), 1, 0, 0, {4, 4});
    AddSprite(TrapState::start, ASSETS_PATH("/img/trap/flower_boom.png"), 12, 0.1, 12*0.1, {4, 4});
    AddSprite(TrapState::interm, ASSETS_PATH("/img/trap/orc_to_sleep.png"), 13, 0.1, 13*0.1, {4, 4});
    AddSprite(TrapState::finish, ASSETS_PATH("/img/trap/orc_sleep.png"), 12, 0.1, 6*12*0.1, {4, 4});
    AddSprite(TrapState::after, ASSETS_PATH("/img/trap/orc_waking.png"), 36, 0.1, 40*0.1, {4, 4});
    ...
    AddSound("sleep", ASSETS_PATH("/audio/orc_sleeping.wav"));
    AddSound("flower_swoosh", ASSETS_PATH("/audio/flower_fx.wav"));
}
