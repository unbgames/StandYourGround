...
void MainState::LoadAssets() {
    ...
    if(vector != nullptr) {
        ...
        vector->AddSprite("cast_dir", "./assets/img/elfa/casting/elfa_cast_dir.png", 24, 0.07, 0.0, {4, 4});
        vector->AddSprite("cast_esq", "./assets/img/elfa/casting/elfa_cast_esq.png", 24, 0.07, 0.0, {4, 4});
